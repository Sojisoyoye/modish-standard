...
export default async function Footer() {
  ...
  return (
    <footer className="bg-[#0C1A4A] text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <p className="mt-5 text-sm text-white/60 leading-relaxed">
              Premium board materials and architectural finishes for Nigeria&apos;s finest craftsmen, interior designers, and contractors.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <svg className="h-5 w-5 text-[#2D8B3C] mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <li className="flex items-center gap-3">
                <svg className="h-5 w-5 text-[#2D8B3C] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href={`tel:${phone}`} className="text-sm text-white/60 hover:text-white transition-colors">
                  {phone}
                </a>
              </li>
              <li className="flex items-center gap-3">
            ...
            <div className="mt-5 flex gap-3">
              <a
                ...
                className="flex h-12 w-12 items-center justify-center rounded-lg bg-[#1877F2] text-white transition-opacity hover:opacity-80"
              >
              ...
              <a
                ...
                className="flex h-12 w-12 items-center justify-center rounded-lg text-white transition-opacity hover:opacity-80"
              ...
              <a
                ...
                className="flex h-12 w-12 items-center justify-center rounded-lg bg-[#010101] text-white transition-opacity hover:opacity-80"
              >
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-white/40">
            &copy; 2026 Modish Standard. All rights reserved.
          </p>
